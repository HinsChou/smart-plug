...
public class SetLightModeItemRspMessage extends baseRspMessage {
	public SetLightModeItemRspMessage(){
		super();
		MsgType = MessageDef.MESSAGE_TYPE_GET_LIGHT_MODE_ITEM_RSP;
	}
	...
	public void setContentBuf(byte[] b){
		contentbuf = b;
	}
}
